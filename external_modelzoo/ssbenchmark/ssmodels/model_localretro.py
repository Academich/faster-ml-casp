...
class model_localretro(SSMethod):
    def __init__(self, module_path=None):
        ...
        if module_path is not None:
            sys.path.insert(len(sys.path), os.path.abspath((os.path.join(module_path))))
            sys.path.insert(len(sys.path), os.path.abspath((os.path.join(module_path))))
    ...
    def model_setup(self, use_gpu=False, **kwargs):
        ...
        kwargs.setdefault("config_path", "/home/mikhail/work/faster_ml_casp/LocalRetro/data/configs/default_config.json")
